        ...
        <div className="flex items-center gap-1">
          {isMd && (
            <Tooltip>
              ...
              />
              <TooltipContent>
                {editing ? t("skills.fileViewer.preview") : t("skills.fileViewer.edit")}
              </TooltipContent>
            </Tooltip>
          )}
        </div>
      ...
      <div className="flex-1 min-h-0 overflow-y-auto">
        {isMd && !editing ? (
          <div className="p-6">
            ...
            <Markdown mode="full">
              {body || t("skills.fileViewer.noContent")}
            </Markdown>
          </div>
        ) : (
          <Textarea
            ...
            placeholder={
              isMd
                ? t("skills.fileViewer.placeholderMarkdown")
                : t("skills.fileViewer.placeholderFile")
            }
