...
export function AssigneePicker({
  ...
  const triggerLabel =
    assigneeType && assigneeId
      ...
      : t("issues.picker.assignee.unassigned");
  ...
  return (
    <PropertyPicker
      ...
      align={align}
      searchable
      searchPlaceholder={t("issues.picker.assignee.assignTo")}
      ...
      trigger={
        customTrigger ? customTrigger : assigneeType && assigneeId ? (
          ...
          <span className="text-muted-foreground">{t("issues.picker.assignee.unassigned")}</span>
        )
      }
    >
      ...
      {filteredMembers.length > 0 && (
        <PickerSection label={t("issues.picker.assignee.members")}>
      ...
      {filteredAgents.length > 0 && (
        <PickerSection label={t("issues.picker.assignee.agents")}>
