      ...
      <div className="px-5 pb-4 pt-5">
        <div className="flex items-start gap-3">
          ...
          <div className="min-w-0">
            <h2 className="text-base font-semibold">
              {t("issues.backlogHint.title")}
            </h2>
            <p className="mt-1 text-sm leading-5 text-muted-foreground">
              {t("issues.backlogHint.description")}
            </p>
          </div>
        </div>
        ...
        <div className="mt-4 grid gap-2 rounded-lg border bg-muted/35 p-3 text-sm">
          <div className="flex items-center gap-2 text-muted-foreground">
            ...
            <span className="font-medium text-foreground">{t("issues.backlogHint.backlog")}</span>
            <span className="text-muted-foreground">{t("issues.backlogHint.backlogDesc")}</span>
          </div>
          <div className="flex items-center gap-2 text-muted-foreground">
            <ArrowRight className="size-4 shrink-0" />
            <span className="font-medium text-foreground">{t("issues.backlogHint.todo")}</span>
            <span className="text-muted-foreground">{t("issues.backlogHint.todoDesc")}</span>
      ...
      <div className="border-t bg-muted/25 px-5 py-4">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <label className="flex min-w-0 cursor-pointer items-center gap-2 text-sm text-muted-foreground">
            ...
            />
            <span className="truncate">{t("issues.backlogHint.dontShowAgain")}</span>
          </label>
          <div className="flex flex-col-reverse gap-2 sm:flex-row sm:justify-end">
            ...
            >
              {t("issues.backlogHint.keepInBacklog")}
            </Button>
            <Button
              type="button"
              className="w-full sm:w-auto"
            ...
            >
              {t("issues.backlogHint.moveToTodo")}
            </Button>
          </div>
        </div>
      </div>
